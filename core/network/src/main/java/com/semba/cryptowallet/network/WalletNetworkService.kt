...
import com.semba.cryptowallet.core.common.BuildConfig
...
interface WalletNetworkService {
    ...
    suspend fun broadcastTransaction(@Path("blockchain") blockchain: String, @Path("network") network: String = BuildConfig.BLOCKCHAIN_NETWORK, @Body rawData: RequestBody): NetworkResponse<BroadcastResponse>
